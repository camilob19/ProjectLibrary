...
class RentalsViewController: UIViewController {
    ...
    var viewModel: RentalsViewModel = RentalsViewModel(loader: BookLoader(),
    ...
    fileprivate func configTableView() {
        ...
        tableView.register(UINib(nibName: nibDetailBook, bundle: nil), forCellReuseIdentifier: nibDetailBook)
